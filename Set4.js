...
function flatten(input){
  var flatArray = input.reduce(function(a,b){
     return a.concat(b);
  }, []);
  return flatArray;
}
...
//Every and Some
/*
var test1 = [NaN, NaN, NaN];

function every(input, condition){
...
//Ancestry
//Actual work is much, much farther below
...
function setAgeDifference(){
  for (var i = 0, len = ancestry.length; i < len; i++){
